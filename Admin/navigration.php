        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
              ...
              <span class="label label-primary pull-right">4</span>
                ...
                <ul class="treeview-menu">
                    <li><a href="category.php"><i class="fa fa-circle-o"></i> Category Name </a></li>
                    <li><a href="category_view.php"><i class="fa fa-circle-o"></i> View Category </a></li>
                    <li><a href="sub_category.php"><i class="fa fa-circle-o"></i> Sub Category </a></li>
                    <li><a href="sub_category_view.php"><i class="fa fa-circle-o"></i> Sub Category View </a></li>
                </ul>
            </li>
            <li>
                <a href="faq.php">
...
<!--                    <li><a href="pages/UI/modals.html"><i class="fa fa-circle-o"></i> Modals</a></li>-->
            ...
            <li class="treeview">
                <a href="#">
                    <i class="fa fa-table"></i> <span>Service Provider </span>
                    <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
                </a>
                <ul class="treeview-menu">
                    <li><a href="serviceprovider.php"><i class="fa fa-circle-o"></i> Service Provider </a></li>
                    <li><a href="service_providerview.php"><i class="fa fa-circle-o"></i> Service Provider List </a></li>
                </ul>
            </li>
            <li>
                <a href="time.php">
                    <i class="fa fa-calendar"></i> <span> Time Shecdule </span>
                    <span class="pull-right-container">
            ...
            <li>
                <a href="expers.php">
                    <i class="fa fa-envelope"></i> <span> Expert Details </span>
                    <span class="pull-right-container">
            ...
            <li class="treeview">
                <a href="#">
                    <i class="fa fa-folder"></i> <span> Bill Payment </span>
                    <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
                </a>
